# [完整版整合包](https://pan.quark.cn/s/887be8e59fa9)
1,下载`AUTOavantar.7z`,解压至任意目录.
2,下载`env_models_v1.6.7.7z`完整模型,解压至AUTOavantar目录.
3,点击`autoavantar.exe`启动系统.
4,后续更新程序会提醒.非重大更新均自动更新,若有重大更新,需要下载增量模型.

**实测4GB显存可以完成全部任务,但是用时非常久,6GB显存则快很多,极限低配谨慎使用**
**注意:20系以下显卡无法使用封面生成功能**
**API_key是我自己充的钱!免费提供,请勿滥用!之前被某个老六一天刷了我好几百块,再这样搞就移除掉了!**
